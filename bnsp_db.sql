...
(5, '2023_01_08_234153_create_skema_table', 1),
(6, '2023_01_08_234336_create_peserta_table', 1);
...
CREATE TABLE `Peserta` (
  ...
  `Kd_skema` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Nm_peserta` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Jekel` enum('Laki-laki','Perempuan') COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'SKM-001', 'Muhamad Iqbal Rivaldi', 'Laki-laki', 'Sumedang', '08762763726');
...
CREATE TABLE `skema` (
  `Kd_skema` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Nm_skema` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Jenis` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Jml_unit` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
ALTER TABLE `Peserta`
  ADD CONSTRAINT `peserta_kd_skema_foreign` FOREIGN KEY (`Kd_skema`) REFERENCES `skema` (`Kd_skema`) ON DELETE CASCADE;
COMMIT;
