    ...
    <div class="container mt-5">
        <form action="{{route('store')}}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" name="Nm_peserta" value="{{old('Nm_peserta')}}" class="form-control {{ $errors->has('Nm_peserta') ? ' is-invalid' : '' }}" placeholder="Masukan Nama Peserta">
            ...
            <div class="form-group mb-3">
              ...
              <div class="form-group mb-3">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="Jekel" id="opsi1" value="{{old('Jekel', 'Laki-laki')}} ">
                    <label class="form-check-label" for="opsi1">Laki-laki</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="Jekel" id="opsi2" value="{{old('Jekel', 'Perempuan')}}">
              ...
              <div class="form-group mb-3">
                ...
                <textarea name="Alamat" class="form-control {{ $errors->has('Alamat') ? ' is-invalid' : '' }}" id="" cols="30" rows="3">{{old('Alamat')}}</textarea>
              ...
              <div class="form-group mb-3">
                ...
                <input type="number" value="{{old('No_hp')}}" name="No_hp" class="form-control {{ $errors->has('No_hp') ? ' is-invalid' : '' }}" placeholder="Masukan No HP">
                @if ($errors->has('No_hp'))
                    <span class="invalid feedback" role="alert">
